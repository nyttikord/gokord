...
type SelectMenu struct {
	...
	// This value determines the minimal amount of selected items in the [SelectMenu].
	MinValues *int `json:"min_values,omitempty"`
	// This value determines the maximal amount of selected items in the [SelectMenu].
	MaxValues int `json:"max_values,omitempty"`
	// Default: true
	Required *bool `json:"required,omitempty"`
	// List of default values for autopopulated [SelectMenu]s.
	//
...
// GroupOption is an option for [RadioGroup] or [CheckboxGroup].
...
// It must be placed inside a [Label].
type RadioGroup struct {
	// CustomID is a developer-defined identifier for the [RadioGroup].
	CustomID string `json:"custom_id,omitempty"`
	// Value selected in the resolved data.
	Value *string `json:"value,omitempty"`
	// Whether the the [Component] is required before submitting the modal (defaults to true).
	Required *bool `json:"required,omitempty"`
	// Options shown in the modal (min: 2, max: 10).
...
func (r *RadioGroup) Type() types.Component {
	return types.ComponentRadioGroup
}
...
func (r *RadioGroup) modal() {}

// CheckboxGroup is an interactive [Component] for selecting one or many options via checkboxes.
// It must be placed inside a [Label].
type CheckboxGroup struct {
	// CustomID is a developer-defined identifier for the [CheckboxGroup].
	CustomID string `json:"custom_id,omitempty"`
	// Minimum number of items that must be chosen (defaults to 1); min 0, max 10.
	MinValues *int `json:"min_values,omitempty"`
	// Maximum number of items that can be chosen (defaults to 1); max 10.
	MaxValues int `json:"max_values,omitempty"`
	// Whether the the [Component] is required before submitting the modal (defaults to true).
	Required *bool `json:"required,omitempty"`
	// Values selected in the resolved data.
...
func (r *CheckboxGroup) Type() types.Component {
	return types.ComponentCheckboxGroup
}

func (r *CheckboxGroup) MarshalJSON() ([]byte, error) {
	return marshalJSON(r)
}

func (r *CheckboxGroup) modal() {}

// Checkbox is a single interactive [Component] for simple yes/no style questions.
// It must be placed inside a [Label].
type Checkbox struct {
	// CustomID is a developer-defined identifier for the [Checkbox].
	CustomID string `json:"custom_id,omitempty"`
	// Whether the checkbox is selected by default.
	Default bool `json:"default"`
	// The state of the checkbox (true if checked).
...
func (r *Checkbox) Type() types.Component {
	return types.ComponentCheckboxGroup
}

func (r *Checkbox) MarshalJSON() ([]byte, error) {
	return marshalJSON(r)
}

func (r *Checkbox) modal() {}
