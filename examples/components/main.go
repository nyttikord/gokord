...
var (
	componentsHandlers = map[string]func(s *gokord.Session, i *event.InteractionCreate){
		"fd_no": func(s *gokord.Session, i *event.InteractionCreate) {
		...
		"fd_yes": func(s *gokord.Session, i *event.InteractionCreate) {
			err := s.InteractionAPI().Respond(i.Interaction, &interaction.Response{
				Type: types.InteractionResponseChannelMessageWithSource,
				Data: &interaction.ResponseData{
		...
		"select": func(s *gokord.Session, i *event.InteractionCreate) {
		...
		"stackoverflow_tags": func(s *gokord.Session, i *event.InteractionCreate) {
			data := i.MessageComponentData()
		...
		"channel_select": func(s *gokord.Session, i *event.InteractionCreate) {
			err := s.InteractionAPI().Respond(i.Interaction, &interaction.Response{
				Type: types.InteractionResponseChannelMessageWithSource,
				Data: &interaction.ResponseData{
	...
	commandsHandlers = map[string]func(s *gokord.Session, i *event.InteractionCreate){
		"buttons": func(s *gokord.Session, i *event.InteractionCreate) {
			err := s.InteractionAPI().Respond(i.Interaction, &interaction.Response{
				Type: types.InteractionResponseChannelMessageWithSource,
				Data: &interaction.ResponseData{
		...
		"selects": func(s *gokord.Session, i *event.InteractionCreate) {
			var response *interaction.Response
